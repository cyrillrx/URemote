...
public class PrefKeys {
	...
	public static final String DEFAULT_LOCAL_PORT			= "0000";
	public static final String DEFAULT_BROADCAST			= "192.168.0.255";
	public static final String DEFAULT_REMOTE_HOST			= "0.0.0.0";
	public static final String DEFAULT_REMOTE_PORT			= "0000";
	public static final String DEFAULT_SECURITY_TOKEN		= "0000";
	public static final String DEFAULT_CONNECTION_TIMEOUT	= "500";
	public static final String DEFAULT_READ_TIMEOUT			= "1000";
