...
public class FileManager extends ListActivity {
	...
	public void onCreate(Bundle _savedInstanceState) {
		...
		mDirectoryPath		= getIntent().getStringExtra(IntentKeys.DIR_PATH);
		mDirectoryContent	= getIntent().getStringExtra(IntentKeys.DIR_CONTENT);
	...
	private void updateView(String infos){
		...
		FileManagerAdapter adpt = new FileManagerAdapter(getApplicationContext(), fileList);
		setListAdapter(adpt);
